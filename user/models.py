...
class Role(BaseModel):
    ...
    user_roles = models.CharField(choices = USER_ROLES,max_length=100,null=True)
...
class UserHistory(BaseModel):
    ...
    package_class_passes = models.IntegerField(null=True,blank=True)
...
class UserClass(BaseModel):
    ...
    booked_day = models.CharField(max_length=50,null=True,blank=True)
    ...
    def __str__(self):
        # return self.select_classes.class_topic
