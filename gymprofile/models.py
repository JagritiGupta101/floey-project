...
class Classes(BaseModel):
    ...
    class_end_date=models.DateField(null=True)
...
class Fitness(BaseModel):
    fitness_type = models.CharField(max_length=100,null=True)
    def __str__(self):
        return str(self.fitness_type)
...
class GymProfile(BaseModel):
    ...
    fitness_types=models.ManyToManyField(Fitness,blank=True)
    ...
    age_criteria = models.ManyToManyField(Age_Group,blank=True)
...
class Transaction(BaseModel):
    ...
    gym = models.ForeignKey(GymProfile,on_delete=models.CASCADE,null=True,blank=True)
    transact_by = models.ForeignKey('user.User',on_delete=models.CASCADE, null=True)
