...
urlpatterns = [
    ...
    # path('classdate/',CourseByDate.as_view(),name = 'classdate'),
    path('gymlist/',GymList.as_view(),name = 'gymlist'),
    path('gymgallery/',GymGallery.as_view(), name='gymGallery'),
    path('class/List/',ClassesList.as_view(),name = 'classList'),
    ...
    path('total/revenue/',TotalRevenue.as_view(),name = 'trevenue'),
    path('class/revenue/',ClassRevenue.as_view(),name = 'clrevenue'),
    path('course/revenue/',CourseRevenue.as_view(),name = 'crrue'),
    path('activeplan/<str:id>/',ActivePackage.as_view(),name = 'crrnue'),
    path('expplan/<str:id>/',ExpPackage.as_view(),name = 'crrnue'),

    path('choose/ammenities/',ChooseAmmenities.as_view())
